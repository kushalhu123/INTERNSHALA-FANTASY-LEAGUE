#IMPORTING THE REQUIRED PY FILES
import sqlite3
import sys
...
from Scoringdb import *

#DATABASE IS CONNECTED
game_db = sqlite3.connect('cricketdata.db')
...
class Game:
    ...
    #WHICH MANAGES THE ACTION OF THE USER
    ...
    def saveTeam(self):
        try:
            ...
            for g in self.team_players:
                ...
                team.append(group)
            if i != 11:
                msg = "Sorry! You Need to add 11 players to start the game!!!"
   ...
   #WHICH EVALUATES THE TEAM
    ...
    #OPEN THE UI TO ENTER THE TEAM NAM
    ...
    #WHERE IT DISABLES REQUIRED WIDGETS
    ...
    #PERFORMS APPROPRIATE ACTION UPONN RECIEVING A TEAM NAME
    def newOrOpenTeam(self, team_name = None):     
        try:
            if team_name == None:
            ...
            if exists == self.exist_required:
                ...
                if self.new_selected == 1:
                    msg = ("""Sorry!!! You already created {} team.
    Create a new team {} """.format(self.team_name,self.team_name))
                elif self.open_selected == 1:
                    msg = ("""Sorry! You forgot to create {} team.
                              create a new team!!""".format(self.team_name))
                self.showMessage(msg)
                #ADDING
                #return
        except Exception as e:
    ...
    #CHECKS WHETHER A TEAM IS ALREADY EXISTING
    
    def checkTeamExists(self, team_name):       
        try:
    ...
    def enableWidgets(self):
        ...
        self.clearSelection()
       #HERE IF ANY ERROR COMES IT WILL GO FOR THIS showMessage function



   #SHOWS MESSAGE FROM USING MESSAGE UI
    def showMessage(self, msg):

        self.ui.msgUi.setupUi(self.ui.msgDialog)
        self.ui.msgUi.MessageLbl.setText(msg)
        self.ui.msgUi.OkButtonBox.setFocus()
        r=self.ui.msgDialog.exec_();
        #r.exec_()
        self.ui.msgUi.MessageLbl.setText('')



     
        
    #CLEARS SELECTION OF LISTS, RADIO BUTTONS, TEAMS, ETC
    def clearSelection(self):      
        ...
        try:
            ...
            pass
        #IF I GET ANY ERROR MESSAGE IT WILL GO TO exceptMsg FUNCTION 
    def exceptMsg(self, e, fn):
        msg = ("""Sorry!, Something Happened We cannot Create a New Team Error: {} {}""".format(e, fn))

        # THERE IT WILL GO FOR SHOW MESSAGE FUNCTION
        self.showMessage(msg)
        #return
    ...
    #FUNCTION TO CHECK PLAYERS IN TEAM
    ...
    def addPlayers(self):
        try:
            ...
            if self.checkAddPermissible(group[0][0], group_count):
                ...
                msg = """Sorry !
                          You Cannot add More than {} {}.""".format(group_count, group[1])
                self.showMessage(msg)
                #return
        except Exception as e:
   ...
   #FUNCTION TO GET QUERY RESULT
    ...
    #IT IS FOR SETTING  EVALUATE DIALOG
    ...
    #FINAL SCORE WHEN YOU GET AFTER CLICKING CALCULATE SCORE
    def getScores(self):
        try:
